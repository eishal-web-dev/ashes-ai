  ...
  <div className="twin-shell">
   ...
   <div className="twin-layout">
    ...
    <aside className="twin-panel">
     ...
     {product.image_url&&<div className="twin-source"><img src={product.image_url} alt="Product reference"/><span><b>{product.image_source_url?'Reference image':'Source product'}</b>{product.image_source_url?'Category reference used for this generated prototype':'Used to guide the final reconstruction'}</span></div>}
