...
def shopify_3d_viewer_path(product_id: str) -> HTMLResponse:
    ...
    return HTMLResponse(
        ...
        headers={
            ...
            "Content-Security-Policy": "frame-ancestors 'self' https://admin.shopify.com https://*.shopify.com https://*.myshopify.com; default-src 'self' https://ajax.googleapis.com; script-src 'self' https://ajax.googleapis.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; connect-src 'self';",
