...
<main>
  ...
  <section id="serviceArea">
    ...
    <div class="notice">Ashes generates only <b>one product at a time per store</b>. Free Trial includes exactly <b>2 total 3D generations</b>. Additional generation packs will be priced after measured GPU cost.</div>
  ...
  <div id="disconnected" class="empty hidden"><strong>Ashes 3D services are disconnected.</strong>Reconnect/install Ashes to restore product generation. Ashes storefront services are disabled while the app is disconnected.</div>
</main>
<script>
const productsEl=document.getElementById('products'),connEl=document.getElementById('conn'),countEl=document.getElementById('count'),engineEl=document.getElementById('engine'),allowanceEl=document.getElementById('allowance'),refreshBtn=document.getElementById('refresh'),plansEl=document.getElementById('plans'),currentPlanEl=document.getElementById('currentPlan'),serviceArea=document.getElementById('serviceArea'),disconnected=document.getElementById('disconnected');
